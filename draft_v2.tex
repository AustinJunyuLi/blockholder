...
%==============================================================================
\begin{abstract}
\noindent How does stake-triggered ownership disclosure shape the sensitivity of takeover premia to market liquidity? I develop a model in which an informed blockholder chooses among exit, passive holding, quiet engagement, and public engagement that triggers mandatory disclosure; a market maker prices order flow, and a bidder conditions entry on market signals. Disclosure partitions order-flow inference into a disclosed branch, where the activism premium is observed, and a nondisclosed branch, where it is inferred. The central result is a disclosure-attenuation theorem: by shifting the activism premium onto an observable basis, stricter disclosure makes takeover premia less sensitive to liquidity, so liquidity sensitivity is lower in strict-disclosure jurisdictions. Supporting this, minority shareholders' takeover gains are single-peaked in liquidity, with an interior optimum governed by the disclosure threshold. Both load-bearing primitives are microfounded: the engagement premium wedge through a free-rider tender game, and the general-equilibrium channel through a certified single-peakedness region.
\end{abstract}
