...
the unknown path derivative), and certifies single-peakedness as a
\emph{theorem} on the interior region where $\bar B$ is dominated --- at the
baseline, $\kappa\in[0.35,0.825]$ under the inversion-free bound and
