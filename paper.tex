...
Together they split every possible history into a flagged cell, in which the filing has landed, and
a pooled cell, in which the market reads order flow alone. Disclosure regulation changes what the
market learns from silence. Non-disclosure itself alters the market's inference. At fixed trading
policies, the liquidity sensitivity of the expected engagement premium factorises as the pooled
