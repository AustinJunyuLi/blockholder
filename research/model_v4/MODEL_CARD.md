...
**Version stamp: 2026-08-28 · re-review audit repairs (P1-row A5 clause + §5 A5 evidence note + A($\tau$) lead + §4.4 O-1 parenthetical) · commit `59c0dfc`.** An answer written against a stale stamp is
