...
**Version stamp: 2026-08-27 · A6 panel resolution (§5 A6/A3 evidence notes + §9 item 4) · commit `<pending-orchestrator-hash>`.** An answer written against a stale stamp is
