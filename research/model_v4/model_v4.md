...
**v4 theory lane, ticket 30 (T2j). Card stamp 2026-08-30, F5 route R40-A applied + batched two-pass
gate PASS + theory-record freeze.**
...
(**Version stamp: 2026-08-30 · F5 route R40-A applied + batched two-pass gate PASS + theory-record
freeze · commit `<pending-orchestrator-hash>`.**) and
...
Seven card events since the 2026-08-23 stamp are carried below. **P1 is restored to PROVED** on
