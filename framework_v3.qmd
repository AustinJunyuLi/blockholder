...
subtitle: "Repositioning Framework v3.1: Angle, Simplified Model, and Empirical Design (revised after referee round)"
author: "Junyu Li"
date: "August 19, 2026"
format:
  pdf:
...
abstract: |
  ...
  framing: the Schedule 13D disclosure rule is a policy lever on the *revelatory* efficiency of
  prices in the market for corporate control — it partitions market inference about activism into a
  disclosed and an inferred branch, and the takeover premium is priced off both. The theory core is
  simplified to a three-branch model with an explicit disclosure primitive, a headline
  comparative static (disclosure attenuation) that is stated exactly as far as it is proved, an
  honest endpoint-plus-region treatment of the liquidity hump, and an empirical section built on the
  SEC's February 5, 2024 acceleration of the 13D filing window. Target: JF/RFS; alternative JFE.
  **v3.1 (2026-08-19):** revised after an internal referee round; see the change log in
  Section 7 and the referee report at `quality_reports/reports/2026-08-19_framework_v3_referee_report.md`.
  Honesty labels from v3 are preserved or strengthened, never weakened.
---
