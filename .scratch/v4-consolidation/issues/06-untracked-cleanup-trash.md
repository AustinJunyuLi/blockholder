...
- [ ] Before trashing `/private/tmp/blockholder-consolidation-handoff.3DjoUp/`, prove that its handoff and the committed `.scratch/v4-consolidation/governing-handoff.md` are byte-identical, that both SHA-256 values equal `b0f99d485900b029f9d4aa41a1668ff958b37f00add1c4b6ababd470065b781c`, and that the committed Git blob has the same hash; record the commands and output in the manifest
