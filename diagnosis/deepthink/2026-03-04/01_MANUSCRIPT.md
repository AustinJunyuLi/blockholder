...
Full LaTeX source of the manuscript (1462 lines). This is the primary object for theory repair.
Key sections for this round:
- Lemma 2 (Endpoint Behavior): lines ~552-556 (statement), lines ~1255-1270 (proof)
- Proposition 5 (Nonmonotonicity): lines ~558-561 (statement), lines ~1272-1281 (proof)
- Premium interpretation: line ~231
- Single-crossing proof (λ_B < 1/2): line ~973
- Lemma 1 (QA Domination): referenced in appendix
- Appendix B.11 (minority gains derivation): line ~1221
