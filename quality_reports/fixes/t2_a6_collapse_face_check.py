...
RUN:  ``.venv/bin/python quality_reports/fixes/t2_a6_collapse_face_check.py``
...
def main() -> int:
    ...
    results["provenance"] = {
        ...
        "sibling_checks": [
            "quality_reports/fixes/t2_a6_edge_jump_check.py -- the three T_2 "
            "jumps at the interior cell edges, where the failure IS live",
            "quality_reports/fixes/t2_a6_node15_check.py -- the kappa = 0.15 "
