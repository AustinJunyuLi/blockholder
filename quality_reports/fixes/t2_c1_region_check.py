...
Run:    .venv/bin/python quality_reports/fixes/t2_c1_region_check.py
        .venv/bin/python quality_reports/fixes/t2_c1_region_check.py --quick
Output: quality_reports/fixes/t2_c1_region_check.json
"""
