...
Run:    .venv/bin/python quality_reports/fixes/t2_p1_fournode_recheck.py
        RECHECK_TIME_BUDGET_S=420 .venv/bin/python quality_reports/fixes/t2_p1_fournode_recheck.py   # budgeted chunk
Output: quality_reports/fixes/t2_p1_fournode_recheck.json (checkpointed after
...
# quality_reports/fixes/t2_p1_check.json -> p1_multistart_existence_sweep ->
...
def main() -> int:
    ...
    results["provenance"] = {
        ...
        "parent_check": "quality_reports/fixes/t2_p1_check.py / .json "
