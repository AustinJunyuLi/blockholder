...
``numerical_v4/checks/a6_panel_probes_2026-08-27/`` and are explicitly
...
RUN:  ``.venv/bin/python numerical_v4/checks/t2_a3_ordered_plans_check.py``
...
def main() -> int:
    ...
    results["provenance"] = {
        ...
        "source_probes": [
            ...
            "numerical_v4/checks/t2_t34_account_sweep.json provenance."
