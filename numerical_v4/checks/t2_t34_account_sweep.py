...
WHAT THIS IS.  ``numerical_v4/checks/t2_p1_fournode_recheck.py`` left four
...
Run:    .venv/bin/python numerical_v4/checks/t2_t34_account_sweep.py
Output: numerical_v4/checks/t2_t34_account_sweep.json
...
# numerical_v4/checks/t2_p1_fournode_recheck.json ("checks" -> "seeds",
...
NODE15_REFERENCE = {
    ...
    "source": "numerical_v4/checks/a6_panel_probes_2026-08-27/"
...
def main() -> int:
    ...
    results["provenance"] = {
        ...
        "sources": {
            "one_node_probe": "numerical_v4/checks/a6_panel_probes_2026-08-27/"
            ...
            "findings": "a6_panel_probes_2026-08-27/a6_B_findings.md 4d/4e/4f "
                        ...
                        "proximity negative)",
            "stalled_nodes": "numerical_v4/checks/t2_p1_fournode_recheck.py "
