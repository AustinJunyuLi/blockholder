...
dominance-and-contraction region carried as a named hypothesis; the region is not exhibited, and
the grid record is that eighteen of eighty nodes satisfy the two pointwise inequalities, in a
largest contiguous block of nine, which verifies neither the full hypothesis nor a nonempty region.
...
making. Its hypothesis set is long, and every clause of it is load-bearing, so the hypotheses
are enumerated rather than gathered into a sentence.
...
\end{enumerate}
\end{lemma}
\resultstatus{Proved under the stated hypotheses (Appendix~\ref{sec:proofs-core}). The use of
...
\end{lemma}
\resultstatus{Proved under the stated hypotheses (Appendix~\ref{sec:proofs-core}). Here
...
\end{lemma}
\resultstatus{Proved under the stated hypotheses (Appendix~\ref{sec:proofs-core}). The
